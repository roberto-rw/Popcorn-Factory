...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Dr. House", R.drawable.drhouse, R.drawable.drwhoheader, "House (Hugh Laurie) with only half a muscle in his right leg. He and his team of medical doctors try\n" +
